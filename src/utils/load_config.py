...
class LoadConfig:
    def __init__(self) -> None:
        ...
        self.llm_system_role_with_history = app_config["llm_config"][
            "llm_system_role_with_history"
        ]
        self.llm_system_role_without_history = app_config["llm_config"][
            "llm_system_role_without_history"
        ]
